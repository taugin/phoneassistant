...
final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        switch (message.what) {
        case CaptureConstant.DECODE:
            decode((byte[]) message.obj, message.arg1, message.arg2);
            break;
        case CaptureConstant.QUIT:
            running = false;
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, CaptureConstant.DECODE_SUCCEEDED, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, CaptureConstant.DECODE_FAILED);
                message.sendToTarget();
            }
        }
    }
