...
import org.join.zxing.FinishListener;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private void decodeOrStoreSavedBitmap(Bitmap bitmap, Result result) {
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler, CaptureConstant.DECODE_SUCCEEDED, savedResultToShow);
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        Message message = Message.obtain(handler, CaptureConstant.RETURN_SCAN_RESULT, intent);
        handler.sendMessage(message);
    }
