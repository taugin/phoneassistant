...
import com.android.phoneassistant.webserver.widget.FileBrowser;
import com.android.phoneassistant.webserver.widget.ProgressBarPreference;
...
public class PreferActivity extends PreferenceActivity {
     ...
     * 恢复某些配置
     */
    public static void restore(Context context, String... keys) {
        SharedPreferences sp = PreferenceManager
                .getDefaultSharedPreferences(context);
        for (String key : keys) {
            restore(sp, key);
                    ...
                    if (which == DialogInterface.BUTTON_POSITIVE) {
                        ...
                        if (pattern.matcher(val).matches()) {
                            ...
                            if (port >= 1024 && port <= 65535) {
                                ...
                                save(sContext, KEY_SERV_PORT, port);
            ...
            final AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.ok, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            save(sContext, KEY_SERV_ROOT, currentRoot);
                        }
